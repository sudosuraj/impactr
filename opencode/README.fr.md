...
Impactr est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/anomalyco/impactr/releases) ou [impactr.dev/download](https://impactr.dev/download).
...
En savoir plus sur les [agents](https://impactr.dev/docs/agents).

### Documentation

Pour plus d'informations sur la configuration d'Impactr, [**consultez notre documentation**](https://impactr.dev/docs).

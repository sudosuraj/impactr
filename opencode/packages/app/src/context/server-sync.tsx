...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: ImpactrClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: ImpactrClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: ImpactrClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => ImpactrClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, ImpactrClient>()

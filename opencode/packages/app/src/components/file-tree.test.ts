...
beforeAll(async () => {
  ...
  mock.module("@impactr-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@impactr-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@impactr-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@impactr-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

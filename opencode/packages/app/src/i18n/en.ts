export const dict = {
  ...
  "dialog.provider.impactr.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.impactr.tagline": "Reliable optimized models",
  "dialog.provider.impactrGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by impactr",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in impactr.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.impactrZen.line1":
    "impactr Pro gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.impactrZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.impactrZen.visit.prefix": "Visit ",
  "provider.connect.impactrZen.visit.link": "impactr.ai/zen",
  "provider.connect.impactrZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in impactr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in impactr.",
  ...
  "dialog.plugins.empty": "Plugins configured in impactr.json",
  ...
  "dialog.server.description": "Switch which impactr server this app connects to.",
  ...
  "wsl.onboarding.step.impactr": "impactr",
  ...
  "wsl.onboarding.checkingImpactr": "Checking impactr...",
  "wsl.onboarding.checkingImpactrIn": "Checking impactr in {{distro}}...",
  "wsl.onboarding.updatingImpactr": "Updating impactr...",
  "wsl.onboarding.updatingImpactrIn": "Updating impactr in {{distro}}...",
  "wsl.onboarding.updateImpactrIn": "Update impactr in {{distro}}.",
  "wsl.onboarding.updateImpactr": "Update impactr",
  "wsl.onboarding.impactrReadyIn": "impactr is ready in {{distro}}.",
  "wsl.onboarding.impactrReady": "impactr is ready.",
  "wsl.onboarding.installImpactrIn": "Install impactr in {{distro}}.",
  "wsl.onboarding.installImpactr": "Install impactr",
  ...
  "wsl.onboarding.distroStatus.impactrMissing": "impactr not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before impactr can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "impactr could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen impactr.",
  ...
  "toast.update.description": "A new version of impactr ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the impactr team",
  ...
  "error.chain.checkConfig": "Check your config (impactr.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, impactr does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "impactr includes free models so you can start immediately.",
  ...
  "app.name.desktop": "impactr Desktop",
  ...
  "settings.desktop.wsl.description": "Run the impactr server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for impactr",
  ...
  "settings.general.row.appearance.description": "Customise how impactr looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether impactr follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how impactr is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when impactr launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of impactr.",

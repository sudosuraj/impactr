export const dict = {
  ...
  "dialog.provider.impactr.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.impactr.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.impactrGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez impactr",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w impactr.",
  ...
  "provider.connect.impactrZen.line1":
    "impactr Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.impactrZen.visit.prefix": "Odwiedź ",
  "provider.connect.impactrZen.visit.link": "impactr.ai/zen",
  "provider.connect.impactrZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w impactr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w impactr.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w impactr.json",
  ...
  "dialog.server.description": "Przełącz serwer impactr, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja impactr ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu impactr",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (impactr.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "impactr zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla impactr",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd impactr na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy impactr ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw impactr.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania impactr",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji impactr.",

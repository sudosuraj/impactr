...
export const dict = {
  ...
  "dialog.provider.impactr.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.impactr.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.impactrGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av impactr",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i impactr.",
  ...
  "provider.connect.impactrZen.line1":
    "impactr Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.impactrZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.impactrZen.visit.prefix": "Besøk ",
  "provider.connect.impactrZen.visit.link": "impactr.dev/zen",
  "provider.connect.impactrZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i impactr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i impactr.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i impactr.json",
  ...
  "dialog.server.description": "Bytt hvilken impactr-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av impactr ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til impactr-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (impactr.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at impactr ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "impactr inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør impactr-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for impactr",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan impactr ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om impactr skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan impactr er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når impactr starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av impactr.",

...
export const dict = {
  ...
  "dialog.provider.impactr.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.impactr.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.impactrGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "impactr tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve impactr'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.impactrZen.line1":
    "impactr Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.impactrZen.visit.prefix": "",
  "provider.connect.impactrZen.visit.link": "impactr.ai/zen",
  "provider.connect.impactrZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve impactr'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak impactr'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler impactr.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi impactr sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "impactr'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı impactr ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (impactr.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: impactr henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "impactr ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "impactr Masaüstü",
  ...
  "settings.desktop.wsl.description": "impactr sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "impactr'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "impactr'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "impactr'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "impactr'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "impactr başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "impactr'un en son sürümünü kullanıyorsunuz.",

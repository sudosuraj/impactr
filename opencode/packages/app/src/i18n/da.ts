export const dict = {
  ...
  "dialog.provider.impactr.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.impactr.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.impactrGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af impactr",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i impactr.",
  ...
  "provider.connect.impactrZen.line1":
    "impactr Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i impactr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i impactr.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i impactr.json",
  ...
  "dialog.server.description": "Skift hvilken impactr-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af impactr ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til impactr-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (impactr.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, impactr understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "impactr inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør impactr-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for impactr",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan impactr ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om impactr følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan impactr er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når impactr starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af impactr.",

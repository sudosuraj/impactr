export const dict = {
  ...
  "dialog.provider.impactr.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.impactr.tagline": "Modelos optimizados y fiables",
  "dialog.provider.impactrGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por impactr",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en impactr.",
  ...
  "provider.connect.impactrZen.line1":
    "impactr Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.impactrZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.impactrZen.visit.prefix": "Visita ",
  "provider.connect.impactrZen.visit.link": "impactr.dev/zen",
  "provider.connect.impactrZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en impactr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en impactr.",
  ...
  "dialog.plugins.empty": "Plugins configurados en impactr.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de impactr se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de impactr ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de impactr",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (impactr.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, impactr no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "impactr incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor impactr dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para impactr",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve impactr en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si impactr sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de impactr.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia impactr",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de impactr.",

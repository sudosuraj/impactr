export const dict = {
  ...
  "dialog.provider.impactr.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.impactr.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.impactrGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo impactr",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no impactr.",
  ...
  "provider.connect.impactrZen.line1":
    "impactr Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.impactrZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.impactrZen.visit.prefix": "Visite ",
  "provider.connect.impactrZen.visit.link": "impactr.ai/zen",
  "provider.connect.impactrZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no impactr.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no impactr.",
  ...
  "dialog.plugins.empty": "Plugins configurados em impactr.json",
  ...
  "dialog.server.description": "Trocar para qual servidor impactr este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do impactr ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do impactr",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (impactr.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: impactr ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "impactr inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor impactr dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do impactr",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o impactr aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o impactr segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o impactr é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o impactr iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do impactr.",

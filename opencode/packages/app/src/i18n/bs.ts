export const dict = {
  ...
  "dialog.provider.impactr.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.impactr.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.impactrGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje impactr",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u impactr-u.",
  ...
  "provider.connect.impactrZen.line1":
    "impactr Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.impactrZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.impactrZen.visit.prefix": "Posjeti ",
  "provider.connect.impactrZen.visit.link": "impactr.dev/zen",
  "provider.connect.impactrZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u impactr-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u impactr-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u impactr.json",
  ...
  "dialog.server.description": "Promijeni na koji se impactr server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija impactr-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku impactr timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (impactr.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: impactr još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "impactr uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni impactr server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u impactr-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako impactr izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li impactr prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu impactr-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se impactr pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju impactr-a.",

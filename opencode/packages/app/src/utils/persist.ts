...
const GLOBAL_STORAGE = "impactr.global.dat"
const WINDOW_STORAGE = "impactr.window"
const LOCAL_PREFIX = "impactr."
...
function workspaceStorage(dir: string) {
  ...
  return `impactr.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `impactr.draft.${head}.${sum}.dat`
}

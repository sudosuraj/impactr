import impactrWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/impactr",
  fallbackStars: "150K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "impactr:stats-theme"
...
function ImpactrMark() {
  return (
    <svg data-slot="impactr-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={impactrWordmarkDark} alt="Impactr" />
          <button

export const dict = {
  "app.title": "Rankingi użycia modeli AI | Impactr Data",
  "app.description":
    "Przeglądaj użycie Impactr Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Impactr Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Impactr na GitHub",
  "header.github": "GitHub",
  "header.tryImpactr": "Wypróbuj Impactr",
  ...
  "footer.homeAria": "Strona główna Impactr",
  ...
  "home.topModelsDescription": "Użycie modeli w Impactr Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Impactr Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Impactr Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Impactr Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Impactr.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Impactr",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Impactr",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Impactr z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Impactr Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Impactr Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Impactr Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Impactr Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Impactr Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Impactr Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Impactr Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Impactr Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Impactr Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Impactr Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Impactr Go.",
  ...
  "model.geoDescription": "Tokeny modelu Impactr Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Impactr Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Impactr Go.",

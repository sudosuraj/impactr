---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala impactr.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

impactr zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie impactr uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI impactr, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do impactr. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij impactr. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `impactr.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Impactr czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `impactr.default`.

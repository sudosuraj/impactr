...
1. Uruchom polecenie `/connect` w TUI, wybierz `Impactr Zen` i przejdź do [impactr.ai/auth](https://impactr.ai/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `Impactr Go` i przejdź do [impactr.ai/auth](https://impactr.ai/zen).

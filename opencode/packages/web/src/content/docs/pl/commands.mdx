...
Utwórz `.impactr/commands/test.md`:
...
Możesz zdefiniować polecenia w `impactr.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji impactr:
...
- Globalnie: `~/.config/impactr/commands/`
- Na projekt: `.impactr/commands/`
...
impactr zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).

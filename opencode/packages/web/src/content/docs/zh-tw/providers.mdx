...
1. 在 TUI 中執行 `/connect` 指令，選擇 `Impactr Zen`，然後前往 [impactr.ai/auth](https://impactr.ai/zen)。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 `Impactr Go`，然後前往 [impactr.ai/auth](https://impactr.ai/zen)。

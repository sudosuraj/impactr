...
O esquema de configuração do servidor/tempo de execução é definido em [**`impactr.ai/config.json`**](https://impactr.ai/config.json).

A configuração do TUI usa [**`impactr.ai/tui.json`**](https://impactr.ai/tui.json).

...
1. Execute o comando `/connect` no TUI, selecione `Impactr Zen` e acesse [impactr.ai/zen](https://impactr.ai/zen).
...
1. Execute o comando `/connect` no TUI, selecione `Impactr Go` e acesse [impactr.ai/zen](https://impactr.ai/zen).

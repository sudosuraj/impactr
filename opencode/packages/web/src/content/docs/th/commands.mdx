...
สร้าง `.impactr/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Impactr:
...
- ระดับผู้ใช้ (Global): `~/.config/impactr/commands/`
- ระดับโปรเจ็กต์: `.impactr/commands/`
...
Impactr มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)

...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก impactr และไปที่ [impactr.ai/auth](https://impactr.ai/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `Impactr Go` และไปที่ [impactr.ai/auth](https://impactr.ai/zen)

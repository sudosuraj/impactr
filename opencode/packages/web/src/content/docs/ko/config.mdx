...
server/runtime config schema는 [**`impactr.ai/config.json`**](https://impactr.ai/config.json)에 정의되어 있습니다.

TUI config는 [**`impactr.ai/tui.json`**](https://impactr.ai/tui.json)을 사용합니다.

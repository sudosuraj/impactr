...
Il file di configurazione ha uno schema definito in [**`impactr.ai/config.json`**](https://impactr.ai/config.json).

La configurazione TUI usa [**`impactr.ai/tui.json`**](https://impactr.ai/tui.json).

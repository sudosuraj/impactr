...
Puoi aggiungere comandi personalizzati tramite la config di Impactr o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Impactr:
...
- Globale: `~/.config/impactr/commands/`
- Per progetto: `.impactr/commands/`
...
impactr include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).

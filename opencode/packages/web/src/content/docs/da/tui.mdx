---
title: TUI
description: Brug af Impactr-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Impactr giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Impactr starter TUI for den nuværende mappe.
...
Når du bruger Impactr TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Impactr. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Impactr. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `impactr.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Impactr venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `impactr.default`.

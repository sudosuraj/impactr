...
Opret `.impactr/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem Impactr-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Impactr [config](/docs/config):
...
- Globalt: `~/.config/impactr/commands/`
- Pr. projekt: `.impactr/commands/`
...
impactr indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).

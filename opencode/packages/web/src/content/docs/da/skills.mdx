...
Agentferdigheter lar Impactr oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Impactr søker etter disse stedene:

- Prosjektkonfigurasjon: `.impactr/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/impactr/skills/<name>/SKILL.md`
...
For prosjektlokale stier går Impactr opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.impactr/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/impactr/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.impactr/skills/git-release/SKILL.md` slik:
...
Impactr viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `impactr.json`:
...
**For innebygde agenter** (i `impactr.json`):

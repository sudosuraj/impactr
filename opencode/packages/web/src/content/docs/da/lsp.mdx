---
title: LSP-servere
description: Impactr integreres med dine LSP-servere.
---

Impactr kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Impactr leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `IMPACTR_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og impactr åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din impactr-konfiguration.

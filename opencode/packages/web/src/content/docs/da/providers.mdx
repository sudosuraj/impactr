...
1. Kør kommandoen `/connect` i TUI, vælg impactr og gå til [impactr.ai/auth](https://impactr.ai/auth).
...
1. Kør kommandoen `/connect` i TUI, vælg `Impactr Go`, og gå til [impactr.ai/auth](https://impactr.ai/zen).

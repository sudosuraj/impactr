...
Crear `.impactr/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Impactr o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Impactr [config](/docs/config):
...
impactr incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).

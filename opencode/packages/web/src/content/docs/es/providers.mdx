...
1. Ejecute el comando `/connect` en TUI, seleccione impactr y diríjase a [impactr.ai/auth](https://impactr.ai/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `Impactr Go` y diríjase a [impactr.ai/auth](https://impactr.ai/zen).

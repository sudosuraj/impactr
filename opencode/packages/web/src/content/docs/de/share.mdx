---
title: Teilen
description: Teile Impactr-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Impactr-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Impactr Folgendes:
...
Impactr hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Impactr den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`impactr.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du impactr in deiner Organisation einsetzt.

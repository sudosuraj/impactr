...
1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie Impactr aus und gehen Sie zu [impactr.ai/auth](https://impactr.ai/auth).
...
1. Führen Sie den Befehl `/connect` in der TUI aus, waehlen Sie `Impactr Go` und gehen Sie zu [impactr.ai/auth](https://impactr.ai/zen).

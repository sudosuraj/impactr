...
1. TUI で `/connect` コマンドを実行し、`Impactr Zen` を選択して、[impactr.ai/zen](https://impactr.ai/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`Impactr Go` を選択して、[impactr.ai/zen](https://impactr.ai/zen) にアクセスします。

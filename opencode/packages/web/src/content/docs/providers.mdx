...
1. Run the `/connect` command in the TUI, select `Impactr Zen`, and head to [impactr.ai/auth](https://impactr.ai/zen).
...
1. Run the `/connect` command in the TUI, select `Impactr Go`, and head to [impactr.ai/auth](https://impactr.ai/zen).

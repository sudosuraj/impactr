...
Konfiguracijski fajl ima šemu koja je definirana u [**`impactr.ai/config.json`**](https://impactr.ai/config.json).

TUI konfiguracija koristi [**`impactr.ai/tui.json`**](https://impactr.ai/tui.json).

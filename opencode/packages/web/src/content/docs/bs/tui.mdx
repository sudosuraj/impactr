---
title: TUI
description: Korištenje korisničkog interfejsa Impactr terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Impactr pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Impactr pokreće TUI za trenutni direktorij.
...
Kada koristite Impactr TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Impactr. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Impactr. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `impactr.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Impactr čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `impactr.default`.

...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite impactr i idite na [impactr.ai/auth](https://impactr.ai/auth).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `Impactr Go` i idite na [impactr.ai/auth](https://impactr.ai/zen).

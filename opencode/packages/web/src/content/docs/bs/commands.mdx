...
Kreiraj `.impactr/commands/test.md`:
...
Možete dodati prilagođene komande kroz Impactr konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Impactr [config](/docs/config):
...
- Globalno: `~/.config/impactr/commands/`
- Po projektu: `.impactr/commands/`
...
Impactr uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note

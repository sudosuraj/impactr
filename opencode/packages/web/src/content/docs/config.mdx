...
The server/runtime config schema is defined in [**`impactr.ai/config.json`**](https://impactr.ai/config.json).

TUI config uses [**`impactr.ai/tui.json`**](https://impactr.ai/tui.json).

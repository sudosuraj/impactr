---
title: TUI
description: استخدام واجهة المستخدم TUI في Impactr.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Impactr واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Impactr إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Impactr في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Impactr. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Impactr. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `impactr.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Impactr بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `impactr.default`.

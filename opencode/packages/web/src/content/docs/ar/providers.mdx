...
1. شغّل الأمر `/connect` في TUI، واختر impactr، ثم انتقل إلى [impactr.ai/auth](https://impactr.ai/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `Impactr Go`، ثم انتقل إلى [impactr.ai/auth](https://impactr.ai/zen).

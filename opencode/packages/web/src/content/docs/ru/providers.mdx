...
1. Запустите команду `/connect` в TUI, выберите `Impactr Zen` и перейдите по адресу [impactr.ai/auth](https://impactr.ai/zen).
...
1. Запустите команду `/connect` в TUI, выберите `Impactr Go` и перейдите по адресу [impactr.ai/auth](https://impactr.ai/zen).

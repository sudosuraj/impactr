...
Файл конфигурации имеет схему, определенную в [**`impactr.ai/config.json`**](https://impactr.ai/config.json).

Конфигурация TUI использует [**`impactr.ai/tui.json`**](https://impactr.ai/tui.json).

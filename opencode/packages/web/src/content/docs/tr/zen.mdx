---
title: Zen
description: impactr tarafından sağlanan seçilmiş modeller listesi.
---
...
Impactr Zen, Impactr ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Impactr'daki diğer sağlayıcılar gibi çalışır. Impactr Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Impactr kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Impactr ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Impactr Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Impactr Zen, Impactr'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Impactr Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Impactr Zen'i seçin ve API anahtarınızı yapıştırın.
...
Impactr yapılandırmanızdaki [model id](/docs/config/#models) `impactr/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `impactr/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Impactr'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Impactr'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Impactr'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Impactr'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Impactr'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Impactr Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Impactr ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.

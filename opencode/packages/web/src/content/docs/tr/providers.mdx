...
1. TUI'de `/connect` komutunu çalıştırın, impactr'u seçin ve [impactr.ai/auth](https://impactr.ai/auth)'ye gidin.
...
1. TUI'de `/connect` komutunu çalıştırın, `Impactr Go`'yu seçin ve [impactr.ai/auth](https://impactr.ai/zen) adresine gidin.

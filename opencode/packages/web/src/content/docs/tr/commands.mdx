...
`.impactr/commands/test.md` oluştur:
...
impactr işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

impactr [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/impactr/commands/`
- Proje başına: `.impactr/commands/`
...
impactr, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).

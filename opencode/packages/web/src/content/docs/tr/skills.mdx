...
Ajan becerileri, impactr'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
impactr su konumlari tarar:

- Proje konfigurasyonu: `.impactr/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/impactr/skills/<name>/SKILL.md`
...
Proje yerel yollarinda impactr, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.impactr/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/impactr/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.impactr/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
impactr, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`impactr.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`impactr.json` icinde):

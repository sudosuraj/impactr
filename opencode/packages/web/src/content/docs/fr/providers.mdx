...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez impactr et dirigez-vous vers [impactr.ai/auth](https://impactr.ai/auth).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez `Impactr Go` et rendez-vous sur [impactr.ai/auth](https://impactr.ai/zen).

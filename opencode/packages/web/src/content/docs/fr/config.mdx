...
Le fichier de configuration a un schéma défini dans [**`impactr.ai/config.json`**](https://impactr.ai/config.json).

La configuration TUI utilise [**`impactr.ai/tui.json`**](https://impactr.ai/tui.json).

...
1. Kjør kommandoen `/connect` i TUI, velg `Impactr Zen` og gå til [impactr.ai/auth](https://impactr.ai/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `Impactr Go`, og gå til [impactr.ai/auth](https://impactr.ai/zen).

---
title: TUI
description: Bruke impactr-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Impactr gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Impactr starter TUI for gjeldende katalog.
...
Når du bruker Impactr TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Impactr. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Impactr. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `impactr.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Impactr venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `impactr.default`.

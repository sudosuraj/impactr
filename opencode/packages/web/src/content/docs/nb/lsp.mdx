---
title: LSP-servere
description: impactr integreres med LSP-serverne dine.
---

Impactr kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Impactr kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `IMPACTR_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og impactr åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Impactr-konfigurasjonen.

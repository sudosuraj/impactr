...
class Database extends Context.Service<Database, DatabaseShape>()("@impactr/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@impactr/example/UserStore") {

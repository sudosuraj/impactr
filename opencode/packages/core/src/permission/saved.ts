...
import { PermissionSaved } from "@impactr-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/v2/PermissionSaved") {}

...
import { Entry, FileSystem, FindInput, Match } from "@impactr-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@impactr-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/v2/FileSystem") {}

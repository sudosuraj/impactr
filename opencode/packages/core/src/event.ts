...
import type { Data, Definition, Payload } from "@impactr-ai/schema/event"
...
import { Durable } from "@impactr-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@impactr-ai/schema/event").ID
export type { Data, Definition, Payload } from "@impactr-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/Event") {}

...
import { FileSystemWatcher } from "@impactr-ai/schema/filesystem-watcher"
...
declare const IMPACTR_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof IMPACTR_LIBC === "undefined" ? undefined : IMPACTR_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@impactr/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.IMPACTR_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.IMPACTR_EXPERIMENTAL_FILEWATCHER) {

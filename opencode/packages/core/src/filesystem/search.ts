...
export class Service extends Context.Service<Service, Interface>()("@impactr/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.IMPACTR_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))

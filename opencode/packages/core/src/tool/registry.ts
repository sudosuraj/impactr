...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@impactr-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/v2/ToolRegistry") {}

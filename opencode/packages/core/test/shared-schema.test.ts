...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@impactr-ai/schema/prompt"
import { Provider } from "@impactr-ai/schema/provider"
import { Project } from "@impactr-ai/schema/project"
import { ProjectDirectories } from "@impactr-ai/schema/project-directories"
import { PermissionV1 } from "@impactr-ai/schema/permission-v1"
...
import { Command } from "@impactr-ai/schema/command"
import { Connection } from "@impactr-ai/schema/connection"
import { Credential } from "@impactr-ai/schema/credential"
import { FileSystem } from "@impactr-ai/schema/filesystem"
import { Integration } from "@impactr-ai/schema/integration"
import { LLM } from "@impactr-ai/schema/llm"
import { Permission } from "@impactr-ai/schema/permission"
import { Plugin } from "@impactr-ai/schema/plugin"
import { Pty } from "@impactr-ai/schema/pty"
import { Reference } from "@impactr-ai/schema/reference"
import { SessionTodo } from "@impactr-ai/schema/session-todo"
import { Skill } from "@impactr-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@impactr-ai/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@impactr-ai/core/command"),
    import("@impactr-ai/core/integration/connection"),
    import("@impactr-ai/core/credential"),
    import("@impactr-ai/core/filesystem"),
    import("@impactr-ai/core/integration"),
    import("@impactr-ai/core/location"),
    import("@impactr-ai/llm"),
    import("@impactr-ai/core/permission"),
    import("@impactr-ai/core/v1/permission"),
    import("@impactr-ai/core/project/copy"),
    import("@impactr-ai/core/pty"),
    import("@impactr-ai/core/project/schema"),
    import("@impactr-ai/core/reference"),
    import("@impactr-ai/core/session/input"),
    import("@impactr-ai/core/session/message"),
    import("@impactr-ai/core/session/todo"),
    import("@impactr-ai/core/session/prompt"),
    import("@impactr-ai/core/skill"),
    import("@impactr-ai/core/v2-schema"),
    import("@impactr-ai/core/schema"),
    import("@impactr-ai/core/workspace"),
  ])

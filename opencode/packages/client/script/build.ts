...
import { compile, emitEffectImported, emitPromise, write } from "@impactr-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "ImpactrEventEncoded",
              import: 'import type { ImpactrEventEncoded } from "@impactr-ai/protocol/groups/event"',
            },
          },
        }),

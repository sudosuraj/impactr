import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@impactr-ai/sdk/v2"
import { SessionTurn } from "@impactr-ai/session-ui/session-turn"
import { SessionReview } from "@impactr-ai/session-ui/session-review"
import { DataProvider } from "@impactr-ai/session-ui/context"
import { FileComponentProvider } from "@impactr-ai/ui/context/file"
import { WorkerPoolProvider } from "@impactr-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@impactr-ai/ui/logo"
import { IconButton } from "@impactr-ai/ui/icon-button"
import { ProviderIcon } from "@impactr-ai/ui/provider-icon"
import { iife } from "@impactr-ai/core/util/iife"
import { Binary } from "@impactr-ai/core/util/binary"
import { NamedError } from "@impactr-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@impactr-ai/ui/tabs"
import { MessageNav } from "@impactr-ai/session-ui/message-nav"
import { FileSSR } from "@impactr-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@impactr-ai/session-ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/impactr-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Impactr</Title>
              </Show>
              <Meta name="description" content="impactr - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/impactr"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />

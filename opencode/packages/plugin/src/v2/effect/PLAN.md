...
- Effect plugins import `@impactr-ai/plugin/v2/effect`, not `@impactr-ai/core`.
- Public domain values use generated `@impactr-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@impactr-ai/plugin/v2/effect`.

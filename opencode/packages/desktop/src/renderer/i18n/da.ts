export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af impactr",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af impactr er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'impactr'-kommandoen.",

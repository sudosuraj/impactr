export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de impactr",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de impactr. ¿Quieres instalarla y reiniciar?",

...
const releaseId = process.env.IMPACTR_RELEASE
if (!releaseId) throw new Error("IMPACTR_RELEASE is required")

const version = process.env.IMPACTR_VERSION
if (!version) throw new Error("IMPACTR_VERSION is required")
...
const macxTarGz = "impactr-desktop-mac-x64.app.tar.gz"
const macaTarGz = "impactr-desktop-mac-arm64.app.tar.gz"

...
import compareVideo from "../../asset/lander/impactr-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/impactr-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="impactr:auth" content={loggedin() ? "true" : "false"} />

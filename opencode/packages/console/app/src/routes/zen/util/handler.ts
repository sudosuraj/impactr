...
import { and, Database, eq, isNull, lt, or, sql } from "@impactr-ai/console-core/drizzle/index.js"
import { KeyTable } from "@impactr-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@impactr-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@impactr-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@impactr-ai/console-core/util/date.js"
import { Identifier } from "@impactr-ai/console-core/identifier.js"
import { Billing } from "@impactr-ai/console-core/billing.js"
import { Actor } from "@impactr-ai/console-core/actor.js"
import { WorkspaceTable } from "@impactr-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@impactr-ai/console-core/model.js"
import { Subscription } from "@impactr-ai/console-core/subscription.js"
import { BlackData } from "@impactr-ai/console-core/black.js"
import { UserTable } from "@impactr-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@impactr-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@impactr-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@impactr-ai/console-core/lite.js"
import { Resource } from "@impactr-ai/console-resource"
...
import { Workspace } from "@impactr-ai/console-core/workspace.js"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-impactr-session") ?? ""
    const requestId = input.request.headers.get("x-impactr-request") ?? ""
    const ocClient = input.request.headers.get("x-impactr-client") ?? ""
    const projectId = input.request.headers.get("x-impactr-project") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-impactr-request")
          headers.delete("x-impactr-session")
          headers.delete("x-impactr-project")
          headers.delete("x-impactr-client")
          return headers
        })(),
        body: reqBody,
      ...
      if (providerInfo.id.startsWith("console.")) {
        const resEndpointId = res.headers.get("x-impactr-endpoint-id")
        const resEndpointModelId = res.headers.get("x-impactr-upstream-model-id")

...
import desktopAppIcon from "../../asset/lander/impactr-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://impactr.dev/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>impactr.dev/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g impactr-ai")}>
                <code>
                  npm i -g <strong>impactr-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g impactr-ai")}>
                <code>
                  bun add -g <strong>impactr-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/impactr")}>
                <code>
                  brew install <strong>anomalyco/tap/impactr</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S impactr")}>
                <code>
                  paru -S <strong>impactr</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask impactr-desktop")}>
                <code>
                  brew install --cask <strong>impactr-desktop</strong>
                </code>
                <CopyStatus />
              </button>

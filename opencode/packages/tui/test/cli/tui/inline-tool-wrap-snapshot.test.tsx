...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "IMPACTR.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/impactr/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/impactr (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/impactr/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/impactr/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const IMPACTR_DB|IMPACTR_DB|IMPACTR_DEV|Global\\.Path\\.data|data =" in packages/impactr/src (115 matches)',
  },
] as const

...
import type { AssistantMessage, FilePart, UserMessage } from "@impactr-ai/sdk/v2"
...
import { IMPACTR_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useImpactrKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.IMPACTR_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },

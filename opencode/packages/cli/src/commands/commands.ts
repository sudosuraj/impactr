...
declare const IMPACTR_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof IMPACTR_CLI_NAME === "string" ? IMPACTR_CLI_NAME : "impactr", {
  description: "Impactr 2.0 preview command line interface",
  commands: [
    Spec.make("api", {

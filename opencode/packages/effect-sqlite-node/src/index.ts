...
export const TypeId: TypeId = "~@impactr-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@impactr-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@impactr-ai/effect-sqlite-node/NodeSqliteClient")

...
export class Service extends Context.Service<Service, Interface>()("@impactr/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __IMPACTR_PHOTON_WASM_PATH?: string }).__IMPACTR_PHOTON_WASM_PATH =

...
import { makeApi } from "@impactr-ai/protocol/api"
import { LocationMiddleware } from "@impactr-ai/server/location"
import { SessionLocationMiddleware } from "@impactr-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("impactr-root")
...
export const InstanceHttpApi = HttpApi.make("impactr-instance")
...
export const ImpactrHttpApi = HttpApi.make("impactr")

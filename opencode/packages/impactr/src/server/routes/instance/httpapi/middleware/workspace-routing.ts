...
>()("@impactr/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@impactr/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.IMPACTR_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.IMPACTR_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-impactr-directory"] || process.cwd()
}

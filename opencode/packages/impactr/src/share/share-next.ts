...
import type * as SDK from "@impactr-ai/sdk/v2"
...
import { SessionShareTable } from "@impactr-ai/core/share/sql"
...
const disabled = process.env["IMPACTR_DISABLE_SHARE"] === "true" || process.env["IMPACTR_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/ShareNext") {}

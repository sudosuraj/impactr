...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@impactr/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@impactr/ACPDirectory") {}

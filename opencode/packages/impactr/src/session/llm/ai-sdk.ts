import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@impactr-ai/llm"
...
// Move this extraction into @impactr-ai/llm when Copilot is handled by the native runtime.

...
import { buildPrompt } from "@impactr-ai/core/session/compaction"
import { SessionCompactionEvent } from "@impactr-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/SessionCompaction") {}

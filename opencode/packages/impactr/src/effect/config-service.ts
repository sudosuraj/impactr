 ...
 *   "@impactr/ServerAuthConfig",
 *   {
 *     password: Config.string("IMPACTR_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("IMPACTR_SERVER_USERNAME").pipe(Config.withDefault("impactr")),
 *   },
 * ) {}
 *

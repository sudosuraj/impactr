...
//
// The saved variant persists across sessions in ~/.local/state/impactr/model.json
...
class Service extends Context.Service<Service, VariantService>()("@impactr/RunVariant") {}

...
import type { Event, GlobalEvent, ImpactrClient } from "@impactr-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@impactr/RunStreamTransport") {}

...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips impactr-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-impactr-directory"]).toBeUndefined()
      expect(forwarded["x-impactr-workspace"]).toBeUndefined()

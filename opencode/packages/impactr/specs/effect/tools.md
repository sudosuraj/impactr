...
Practical reference for the current tool-migration state in `packages/impactr`.
...
Tool tests should use the existing Effect helpers in `packages/impactr/test/lib/effect.ts`:

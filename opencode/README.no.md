...
brew install anomalyco/tap/impactr # macOS og Linux (anbefalt, alltid oppdatert)
brew install impactr              # macOS og Linux (offisiell brew-formel, oppdateres sjeldnere)
...
Impactr er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/anomalyco/impactr/releases) eller [impactr.dev/download](https://impactr.dev/download).
...
1. `$IMPACTR_INSTALL_DIR` - Egendefinert installasjonsmappe
...
Impactr har to innebygde agents du kan bytte mellom med `Tab`-tasten.
...
Les mer om [agents](https://impactr.dev/docs/agents).

### Dokumentasjon

For mer info om hvordan du konfigurerer Impactr, [**se dokumentasjonen**](https://impactr.dev/docs).

### Bidra

Hvis du vil bidra til Impactr, les [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygge på Impactr

Hvis du jobber med et prosjekt som er relatert til Impactr og bruker "impactr" som en del av navnet; for eksempel "impactr-dashboard" eller "impactr-mobile", legg inn en merknad i README som presiserer at det ikke er bygget av Impactr-teamet og ikke er tilknyttet oss på noen måte.

---

**Bli med i fellesskapet** [Discord](https://discord.gg/impactr) | [X.com](https://x.com/impactr)

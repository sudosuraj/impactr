...
Impactr はデスクトップアプリとしても利用できます。[releases page](https://github.com/anomalyco/impactr/releases) から直接ダウンロードするか、[impactr.ai/download](https://impactr.ai/download) を利用してください。
...
[agents](https://impactr.ai/docs/agents) の詳細はこちら。

### ドキュメント

Impactr の設定については [**ドキュメント**](https://impactr.ai/docs) を参照してください。

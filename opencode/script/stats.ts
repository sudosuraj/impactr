...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/impactr/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/impactr...\n")
...
console.log("Fetching npm all-time downloads for impactr-ai...\n")
const npmDownloads = await fetchNpmDownloads("impactr-ai")

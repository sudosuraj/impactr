...
Impactr jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/anomalyco/impactr/releases) lub z [impactr.dev/download](https://impactr.dev/download).
...
Dowiedz się więcej o [agents](https://impactr.dev/docs/agents).

### Dokumentacja

Więcej informacji o konfiguracji Impactr znajdziesz w [**dokumentacji**](https://impactr.dev/docs).

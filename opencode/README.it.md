...
brew install anomalyco/tap/impactr # macOS e Linux (consigliato, sempre aggiornato)
brew install impactr              # macOS e Linux (formula brew ufficiale, aggiornata meno spesso)
sudo pacman -S impactr            # Arch Linux (Stable)
paru -S impactr-bin               # Arch Linux (Latest from AUR)
mise use -g impactr               # Qualsiasi OS
nix run nixpkgs#impactr           # oppure github:anomalyco/impactr per l’ultima branch di sviluppo
```
...
1. `$IMPACTR_INSTALL_DIR` – Directory di installazione personalizzata
2. `$XDG_BIN_DIR` – Percorso conforme alla XDG Base Directory Specification
3. `$HOME/bin` – Directory binaria standard dell’utente (se esiste o può essere creata)
4. `$HOME/.impactr/bin` – Fallback predefinito
...
Impactr include due agenti integrati tra cui puoi passare usando il tasto `Tab`.
...
Se sei interessato a contribuire a Impactr, leggi la nostra [guida alla contribuzione](./CONTRIBUTING.md) prima di inviare una pull request.

### Costruire su Impactr

Se stai lavorando a un progetto correlato a Impactr e che utilizza “impactr” come parte del nome (ad esempio “impactr-dashboard” o “impactr-mobile”), aggiungi una nota nel tuo README per chiarire che non è sviluppato dal team Impactr e che non è affiliato in alcun modo con noi.

---

**Unisciti alla nostra community** [Discord](https://discord.gg/impactr) | [X.com](https://x.com/impactr)

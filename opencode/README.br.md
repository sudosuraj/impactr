...
O Impactr também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/anomalyco/impactr/releases) ou em [impactr.ai/download](https://impactr.ai/download).
...
Saiba mais sobre [agents](https://impactr.ai/docs/agents).

### Documentação

Para mais informações sobre como configurar o Impactr, [**veja nossa documentação**](https://impactr.ai/docs).

...
Impactr также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/anomalyco/impactr/releases) или с [impactr.ai/download](https://impactr.ai/download).
...
Подробнее об [agents](https://impactr.ai/docs/agents).

### Документация

Больше информации о том, как настроить Impactr: [**наши docs**](https://impactr.ai/docs).

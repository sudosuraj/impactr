...
Desktop application and browser-based app issues, including `impactr web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core impactr server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Impactr Zen, Impactr Go, and billing issues.

...
- PR #13942: https://github.com/anomalyco/impactr/pull/13942

## Do Not Translate (Locale Additions)

- `Impactr` (preserve casing in prose; keep `impactr` only when it is part of commands, package names, paths, or code)
- `Impactr Zen`
- `Impactr CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `impactr` in prose when referring to the product name; use `Impactr`

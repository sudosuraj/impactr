...
- PR #10809: https://github.com/anomalyco/impactr/pull/10809
- PR #11496: https://github.com/anomalyco/impactr/pull/11496

## Do Not Translate (Locale Additions)

- `Impactr` (preserve casing in prose; keep `impactr` only in commands, package names, paths, or code)
- `Impactr CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`

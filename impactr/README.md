...
<p align="center">The open source autonomous pentesting agent.</p>
<p align="center">
...
Impactr includes built-in agents you can switch between with the `Tab` key.

- **attack** - Default, full-access agent for executing the complete pentest lifecycle
- **recon** - Read-only agent for attack surface mapping and technology identification
  - Denies file edits by default
  - Asks permission before running bash commands
  - Ideal for exploring unfamiliar infrastructure or planning attacks

Also included are subagents like **enumerate**, **exploit**, and **report** for handling specific phases of an engagement.
These are used internally and can be invoked dynamically.

...
const tableBucketName = `impactr-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `impactr-${$app.stage}-lake-ingest`,
    destination: "iceberg",

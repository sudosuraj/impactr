...
Use this folder for locale-specific translation guidance that supplements `.impactr/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/impactr/pull/12345

## Do Not Translate (Locale Additions)

- `Impactr` (preserve casing)

...
- PR #15835: https://github.com/anomalyco/impactr/pull/15835

## Do Not Translate (Locale Additions)

- `Impactr` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `impactr` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Impactr` in prose, `impactr` only for exact technical identifiers
...
- Avoid changing `impactr` to `Impactr` inside commands, URLs, package names, or code literals

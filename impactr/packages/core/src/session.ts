...
import { ListAnchor } from "@impactr-ai/schema/session"
...
import { SessionDurable } from "@impactr-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/v2/Session") {}

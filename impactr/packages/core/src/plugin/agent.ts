...
const BUILD_SYSTEM =
  "You are impactr, a high-performance AI coding agent. You move fast, write clean code, and take initiative. Help the user accomplish software engineering tasks by inspecting the workspace, making targeted changes, and using tools according to the configured permissions. When tests exist, run them automatically after changes. Prefer action over asking for permission."
      ...
      draft.update(AgentV2.ID.make("plan"), (item) => {
        ...
        item.permissions.push(
          ...PermissionV2.merge(defaults, [
            ...
            { action: "edit", resource: path.join(".impactr", "plans", "*.md"), effect: "allow" },
            {
              action: "edit",

...
import { Event } from "@impactr-ai/schema/project-directories"
import { ProjectCopy } from "@impactr-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/ProjectCopy") {}

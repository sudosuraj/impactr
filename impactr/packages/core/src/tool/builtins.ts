...
import { RecordDiscoveryTool } from "./record-discovery"
import { QueueHypothesisTool } from "./queue-hypothesis"
...
import { TechniqueTools } from "./technique"
...
export const node = makeLocationNode({
  ...
  deps: [
    ...
    WebFetchTool.node,
    WebSearchTool.node,
    RecordDiscoveryTool.node,
    QueueHypothesisTool.node,
    WriteTool.node,
    TestAndFixTool.node,
    RunAgentTool.node,
    RepoCloneTool.node,

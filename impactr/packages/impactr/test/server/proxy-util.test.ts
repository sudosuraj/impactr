...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips impactr-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-impactr-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-impactr-directory")).toBeNull()
      expect(result.get("x-impactr-workspace")).toBeNull()

...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders IMPACTR_CALLER", () => {
    process.env["IMPACTR_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode IMPACTR_CALLER", () => {
    process.env["IMPACTR_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown IMPACTR_CALLER", () => {
    process.env["IMPACTR_CALLER"] = "unknown"

...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/impactr.git")).toEqual({ owner: "sst", repo: "impactr" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/impactr")).toEqual({ owner: "sst", repo: "impactr" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/impactr.git")).toEqual({ owner: "sst", repo: "impactr" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/impactr")).toEqual({ owner: "sst", repo: "impactr" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/impactr.git")).toEqual({ owner: "sst", repo: "impactr" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/impactr")).toEqual({ owner: "sst", repo: "impactr" })
})

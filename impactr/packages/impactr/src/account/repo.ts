...
import { AccountStateTable, AccountTable } from "@impactr-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/AccountRepo") {}

...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "impactr-gitlab-auth"
import { PoeAuthPlugin } from "impactr-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/Plugin") {}

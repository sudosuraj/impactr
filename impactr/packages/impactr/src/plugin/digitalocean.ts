import type { Hooks, PluginInput } from "@impactr-ai/plugin"
import type { Model } from "@impactr-ai/sdk/v2"
import { InstallationVersion } from "@impactr-ai/core/installation/version"
import { OauthCallbackPage } from "@impactr-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Impactr will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",

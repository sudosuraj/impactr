...
export const Parameters = Schema.Struct({
  ...
  exclude: Schema.optional(Schema.String).annotate({
    description: 'File pattern to exclude from the search (e.g. "*.log", "node_modules/**")',
  }),
...
export const GrepTool = Tool.define(
  ...
  Effect.gen(function* () {
    ...
    return {
      ...
      execute: (
        params: { pattern: string; path?: string; include?: string; exclude?: string; ignoreCase?: boolean },
        ctx: Tool.Context,
      ) =>
        Effect.gen(function* () {
          const empty = {

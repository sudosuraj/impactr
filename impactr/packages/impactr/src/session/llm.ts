...
import { llmClient } from "@impactr-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@impactr-ai/llm"
import { LLMClient } from "@impactr-ai/llm/route"
import type { LLMClientService } from "@impactr-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via impactr's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @impactr-ai/llm. It

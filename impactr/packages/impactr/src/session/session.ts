...
import { Slug } from "@impactr-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@impactr-ai/llm"
...
import { locationServiceMapLayer } from "@impactr-ai/core/location-services"
...
import { PartTable, SessionTable } from "@impactr-ai/core/session/sql"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".impactr", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@impactr/Session") {}

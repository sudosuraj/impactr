...
import { SessionStatusEvent } from "@impactr-ai/schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/SessionStatus") {}

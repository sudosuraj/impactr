...
import { MAX_STEPS_PROMPT } from "@impactr-ai/core/session/runner/max-steps"
...
import { LLMEvent } from "@impactr-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/SessionPrompt") {}

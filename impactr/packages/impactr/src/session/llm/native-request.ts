import type { JsonSchema, LLMRequest, ProviderMetadata } from "@impactr-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@impactr-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @impactr-ai/llm request objects from impactr's session/AI SDK-shaped data.
  return LLM.request({

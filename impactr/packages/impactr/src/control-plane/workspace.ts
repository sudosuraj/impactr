...
import { EventSequenceTable, EventTable } from "@impactr-ai/core/event/sql"
...
import { WorkspaceEvent } from "@impactr-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        IMPACTR_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        IMPACTR_WORKSPACE_ID: config.id,
        IMPACTR_EXPERIMENTAL_WORKSPACES: "true",

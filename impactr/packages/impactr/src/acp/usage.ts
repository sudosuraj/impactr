...
import type { AssistantMessage as ImpactrAssistantMessage, Message } from "@impactr-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@impactr-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<ImpactrAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<ImpactrAssistantMessage, "role"> &
  Partial<Pick<ImpactrAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@impactr/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@impactr/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@impactr/ACPUsage") {}

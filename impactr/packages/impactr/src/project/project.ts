...
import { ProjectDirectoryTable, ProjectTable } from "@impactr-ai/core/project/sql"
import { ProjectDirectories } from "@impactr-ai/core/project/directories"
...
import { which } from "@impactr-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@impactr/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.IMPACTR_FAKE_VCS)

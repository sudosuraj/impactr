...
import { normalizePromptContent } from "@impactr-ai/tui/editor"
...
import { IMPACTR_BASE_MODE, useBindings } from "@impactr-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Impactr" } satisfies SlashOption,
    ]

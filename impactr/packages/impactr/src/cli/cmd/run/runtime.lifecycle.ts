...
import { openEditor } from "@impactr-ai/tui/editor"
import { registerImpactrKeymap } from "@impactr-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerImpactrKeymap(keymap, renderer, input.tuiConfig)

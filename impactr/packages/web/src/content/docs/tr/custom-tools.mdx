---
title: Özel Araçlar
description: LLM'un impactr'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. impactr'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.impactr/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/impactr/tools/` içine yerleştirerek.

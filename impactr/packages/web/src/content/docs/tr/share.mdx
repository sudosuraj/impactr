---
title: Paylasim
description: impactr konusmalarini genel baglantilarla paylasin.
---

impactr'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda impactr:
...
impactr, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak impactr manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `impactr.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda impactr kullanimi icin [daha fazla bilgi alin](/docs/enterprise).

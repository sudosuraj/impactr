...
Erstellen Sie `.impactr/commands/test.md`:

```md title=".impactr/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Impactr-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Impactr [config](/docs/config):

```json title="impactr.jsonc" {4-12}
{
...
- Global: `~/.config/impactr/commands/`
- Pro Projekt: `.impactr/commands/`

```markdown title="~/.config/impactr/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".impactr/commands/component.md"
---
...
```md title=".impactr/commands/create-file.md"
---
...
```md title=".impactr/commands/analyze-coverage.md"
---
...
```md title=".impactr/commands/review-changes.md"
---
...
```md title=".impactr/commands/review-component.md"
---
...
Impactr enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).

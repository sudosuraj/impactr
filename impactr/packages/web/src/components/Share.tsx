...
import { IconImpactr } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "impactr/session/message-v2"
import type { Message } from "impactr/session/message"
import type { Session } from "impactr/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.impactr_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.impactr_name}>
                    <IconImpactr width={16} height={16} />
                  </div>

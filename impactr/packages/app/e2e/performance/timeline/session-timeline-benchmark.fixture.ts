...
import { mockImpactrServer } from "../../utils/mock-server"
import { expectAppVisible, expectSessionTitle } from "../../utils/waits"
import { expect } from "../benchmark"

const directory = "C:/Impactr/TimelineStateRegression"
...
const model = { providerID: "impactr", modelID: "claude-opus-4-6", variant: "max" }
...
function provider() {
  return {
    ...
    connected: ["impactr"],
    default: { providerID: "impactr", modelID: "claude-opus-4-6" },
  }
}

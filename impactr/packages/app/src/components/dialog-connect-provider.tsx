import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@impactr-ai/sdk/v2/client"
...
import { List, type ListRef } from "@impactr-ai/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "impactr"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.impactrZen.line1")}</div>

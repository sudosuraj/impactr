...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "impactr", key: "dialog.provider.impactr.note" },
  { match: (id: string) => id === "impactr-go", key: "dialog.provider.impactrGo.tagline" },
...
export const SettingsProvidersV2: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "impactr" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "impactr" || item.id === "impactr-go"}>

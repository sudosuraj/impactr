...
import { SelectV2 } from "@impactr-ai/ui/v2/select-v2"
import { Switch } from "@impactr-ai/ui/v2/switch-v2"
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_IMPACTR_CHANNEL !== "prod"}>
          <SettingsRowV2

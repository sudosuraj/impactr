...
import type { Definition } from "@impactr-ai/schema/event"
...
export const ImpactrEvent = event.schema
export type ImpactrEvent = typeof ImpactrEvent.Type
export type ImpactrEventEncoded = typeof ImpactrEvent.Encoded

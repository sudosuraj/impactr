...
const en = {
  "app.title": "AI Model Usage Rankings | Impactr Data",
  "app.description":
    "Explore Impactr Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Impactr Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Impactr on GitHub",
  "header.github": "GitHub",
  "header.tryImpactr": "Try Impactr",
  ...
  "home.topModelsDescription": "Usage of models across Impactr Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Impactr Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Impactr Data",
  "lab.description":
    "Compare {{lab}} models used in Impactr Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Impactr usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Impactr",
  ...
  "lab.shareOfUsage": "{{share}} of recent Impactr usage",
  "lab.usageTitle": "{{lab}} token usage",
  "lab.usageDescription": "Daily Impactr token volume over the last two months.",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Impactr Data",
  "model.description":
    "View {{model}} Impactr Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Impactr Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Impactr Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Impactr Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Impactr Go usage in the current data window.",
  ...
  "model.inputs": "Inputs",
  "model.overviewDescription": "Recent Impactr Go tokens, unique users, and market position.",
  "model.noSummaryTitle": "No usage summary",
  "model.noSummaryDescription": "This model has no Impactr Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daily Impactr Go token volume over the recent two-month window.",
  ...
  "model.usersDescription": "Daily unique Impactr Go users over the recent two-month window.",
  ...
  "model.efficiencyDescription": "Cost, cache behavior, and average Impactr Go session shape.",
  ...
  "model.geoDescription": "Impactr Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Impactr Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Impactr Go token volume.",

...
Schema-first LLM core for impactr. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@impactr-ai/llm"
import { OpenAI } from "@impactr-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@impactr-ai/llm/providers"

...
يتوفر Impactr ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/anomalyco/impactr/releases) او من [impactr.dev/download](https://impactr.dev/download).
...
تعرف على المزيد حول [agents](https://impactr.dev/docs/agents).

### التوثيق

لمزيد من المعلومات حول كيفية ضبط Impactr، [**راجع التوثيق**](https://impactr.dev/docs).
